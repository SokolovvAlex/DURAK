...
#
# async def main():
#     # Подставь реальные параметры
#     redis_client = RedisClient(
#         host="localhost",  # если Redis в докере и порты проброшены
#         port=6379,
#         ssl_flag=False,    # у тебя без SSL
#         password=None
#     )
#
...
#
#     # Запишем и прочитаем значение
#     await client.set("test_key", "hello_world")
#     value = await client.get("test_key")
#
#     logger.info(f"Тестовое значение из Redis: {value.decode()}")
